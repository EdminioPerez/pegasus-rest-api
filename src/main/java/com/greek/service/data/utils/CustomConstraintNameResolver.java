...
public class CustomConstraintNameResolver implements ContraintsNameResolver {
    ...
    static {
        constraintCodeMap.put(
                "uq_cedula_id_categoria_persona_id_organizacion",
                "exception.document.identification.exists");
        constraintCodeMap.put(
                "fk_id_ubicacion_geografica_nacimiento_from_persona",
        ...
        constraintCodeMap.put(
                "fk_id_codigo_postal_from_persona", "exception.postal.code.not.exists");
        constraintCodeMap.put(
                "fk_id_tipo_documento_identificacion_from_persona",
                "exception.identity.document.type.not.exists");
        constraintCodeMap.put(
                "meals_unique_user_datetime_idx", "exception.meals.duplicate_datetime");
